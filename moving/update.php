...
if(isset($_POST["id"]))
{
    ...
    if(empty($name_err) && empty($desc_err)){
        ...
        $sql = "UPDATE service SET service_name=?, description=?, image=? , service_type=? WHERE service_id=?";
        //echo "sql";

        if($stmt = mysqli_prepare($con, $sql)){
            // Bind variables to the prepared statement as parameters
            //
            mysqli_stmt_bind_param($stmt, "ssssi", $param_name, $param_description,$param_image,$param_type, $param_id);
            echo "id is :".$id;
            // Set parameters
